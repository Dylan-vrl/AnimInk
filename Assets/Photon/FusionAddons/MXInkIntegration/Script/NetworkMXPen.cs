...
namespace Fusion.Addons.MXPenIntegration {
    ...
    public class NetworkMXPen : NetworkBehaviour, INetworkGrabber
    {
        ...
        public Grabber grabber => IsLocalNetworkRig ? rig.hardwareRig.pen.GetComponentInParent<Grabber>() : null;
