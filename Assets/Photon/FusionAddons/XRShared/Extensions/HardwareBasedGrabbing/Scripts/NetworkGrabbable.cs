...
namespace Fusion.XR.Shared.Grabbing
{
    ...
    public class NetworkGrabbable : NetworkBehaviour
    {
        ...
        {
            if (isTakingAuthority == false && Object.HasStateAuthority && CurrentGrabber && CurrentGrabber.Object.StateAuthority != Object.StateAuthority)
            {
                CurrentGrabber = null;
            }
        ...
        protected virtual void ExtrapolateWhileTakingAuthority()
        {
            ...
            var follwedGrabberRoot = networkGrabber.hand != null ? networkGrabber.hand.transform : networkGrabber.transform;
